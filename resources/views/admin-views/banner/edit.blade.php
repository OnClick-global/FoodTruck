            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                            class="tio-edit"></i>{{__('messages.update')}} {{__('messages.banner')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control"
                                               placeholder="{{__('messages.new_banner')}}" value="{{$banner->title}}"
                                               required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="zone_id" id="zone" class="form-control js-select2-custom"
                                            ...
                                            @foreach($zones as $zone)
                                                <option
                                                    value="{{$zone['id']}}" {{$zone->id == $banner->zone_id?'selected':''}}>{{$zone['name']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="banner_type" class="form-control"
                                            ...
                                            <option
                                                value="restaurant_wise" {{$banner->type == 'restaurant_wise'? 'selected':'' }}>{{__('messages.restaurant')}} {{__('messages.wise')}}</option>
                                            <option
                                                value="item_wise" {{$banner->type == 'item_wise'? 'selected':'' }}>{{__('messages.food')}} {{__('messages.wise')}}</option>
                                        </select>
                                    </div>
                                    <div class="form-group" id="restaurant_wise">
                                        ...
                                        <select name="restaurant_id" class="js-data-example-ajax" id="resturant_ids"
                                    ...
                                    <div class="form-group" id="item_wise">
                                        ...
                                        <select name="item_id" id="choice_item" class="form-control js-select2-custom"
                                                placeholder="{{__('messages.select_food')}}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-3" hidden>
                                            ...
                                            <select name="ads_type" class="form-control"
                                                ...
                                                <option @if($banner->ads_type =='clicks') selected @endif  value="clicks">{{__('messages.clicks')}}</option>
                                                <option  @if($banner->ads_type =='views') selected @endif  value="views">{{__('messages.views')}}</option>
                                                <option  @if($banner->ads_type =='duration')  selected @endif  value="duration">{{__('messages.duration')}}</option>
                                            </select>
                                        </div>
                                        @if($banner->ads_type =='clicks' || $banner->ads_type =='views'  )
                                        <div class=" col-3" id="count">
                                            <label class="input-label"
                                                   for="exampleFormControlInput1">count</label>
                                            <input type="text" value="{{$banner->type_count}}" name="type_count" class="form-control">
                                        </div>
                                        @endif
                                        @if($banner->ads_type =='duration')
                                            <div class=" col-3" id="duration_start">
                                                <label class="input-label"
                                                       for="exampleFormControlInput1">Starts at</label>
                                                <input type="date" value="{{$banner->start_date}}" name="start_date" class="form-control" id="date_from">
                                            </div>

                                            <div class=" col-3" id="duration_end">
                                                <label class="input-label"
                                                       for="exampleFormControlInput1">Ends at</label>
                                                <input type="date" name="end_date" value="{{$banner->end_date }}" class="form-control" id="date_from">
                                            </div>
                                        @endif
                                    </div>
                                </div>
