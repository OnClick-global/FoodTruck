                ...
                <form action="{{route('admin.business-settings.update-setup')}}" method="post"
                    ...
                    <div class="form-group">
                        <label class="input-label"
                               for="exampleFormControlInput1">{{__('messages.business')}} {{__('messages.name')}}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label class="input-label"
                                       for="exampleFormControlInput1">{{__('messages.Profit_Ratio')}}</label>
                                @php($Profit_Ratio=\App\Models\BusinessSetting::where('key','Profit_Ratio')->first())

                                <input type="text" name="Profit_Ratio" value="{{$Profit_Ratio->value??''}}"
                                       class="form-control"
                                       placeholder="{{__('messages.Profit_Ratio')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label class="input-label"
                                       for="exampleFormControlInput1">{{__('messages.Annual_subscription')}}</label>
                                @php($Annual_subscription=\App\Models\BusinessSetting::where('key','Annual_subscription')->first())
                                <input type="text" name="Annual_subscription" value="{{$Annual_subscription->value??''}}"
                                       class="form-control"
                                       placeholder="{{__('messages.Annual_subscription')}}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline text-capitalize">{{__('messages.time')}} {{__('messages.zone')}}</label>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{__('messages.scheduled')}} {{__('messages.orders')}}</label><small
                                    style="color: red">
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                   for="schedule_order">{{__('messages.on')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                   for="schedule_order2">{{__('messages.off')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{__('messages.order_confirmation_model')}}</label><small
                                    style="color: red">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{__('messages.admin')}} {{__('messages.order')}} {{__('messages.notification')}}</label><small
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                   for="aon2">{{__('messages.off')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{__('messages.customer')}} {{__('messages.verification')}}</label><small
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{__('messages.order')}} {{__('messages.delivery')}} {{__('messages.verification')}}</label><small
                                    style="color: red"><span
                                        class="input-label-secondary"
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                   for="odc2">{{__('messages.off')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
...
{{--                    </div>--}}
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="input-label text-capitalize d-inline"
                                       for="latitude">{{__('messages.latitude')}}<span
                                        class="input-label-secondary"
                                        title="{{__('messages.click_on_the_map_select_your_defaul_location')}}"><img
                                            src="{{asset('/public/assets/admin/img/info-circle.svg')}}"
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline text-capitalize"
                                       for="longitude">{{__('messages.longitude')}}<span
                                        class="input-label-secondary"
                                        title="{{__('messages.click_on_the_map_select_your_defaul_location')}}"><img
                                            src="{{asset('/public/assets/admin/img/info-circle.svg')}}"
                                            alt="{{__('messages.click_on_the_map_select_your_defaul_location')}}"></span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="input-label d-inline"
                                       for="exampleFormControlInput1">{{__('messages.footer')}} {{__('messages.text')}}</label>
                    ...
                    @php($logo=$logo->value??'')
                    <div class="form-group">
                        <label class="input-label d-inline">{{__('messages.logo')}}</label><small style="color: red">*
                            ( {{__('messages.ratio')}} 3:1 )</small>
                    ...
                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                            ...
                            class="btn btn-primary mb-2">{{trans('messages.submit')}}</button>
                </form>
            </div>
        </div>
    </div>
...
@push('script_2')
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key={{\App\Models\BusinessSetting::where('key', 'map_api_key')->first()->value}}&libraries=places&v=3.45.8"></script>
    <script>
